...
Example scripts for the [ntoseye Python SDK](../docs/scripting/sdk.md):
...
[`ghidra/ntoseye_regions.py`](ghidra/ntoseye_regions.py) is a gdb script for Ghidra's gdb agent when it debugs through [`ntoseye gdbserver`](../docs/integrations/gdbserver.md#ghidra).

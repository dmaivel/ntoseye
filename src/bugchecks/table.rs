//! The bugcheck code table: name, one-line description, and the meaning of
//! each of the four arguments, transcribed from the Windows driver docs.

use super::BugcheckDescriptor;

...
impl Target {
    ...
    pub fn running_data(&self, include_idle: bool) -> Result<RunningDetail> {
    ...
    pub fn apc_layout(&self) -> Result<ApcLayout> {
...
pub struct ApcLayout {
    pub state_offset: u64,
    pub state_is_pointer: bool,
    pub heads_offset: u64,
    pub head_stride: u64,
    pub link_offset: Option<u64>,
    pub kernel_routine: Option<&'static str>,
    pub normal_routine: Option<&'static str>,
}

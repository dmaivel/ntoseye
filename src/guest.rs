use crate::{
    backend::MemoryOps,
    bytes::{read_u16, read_u32, read_u64},
    dmp::DmpInfo,
    error::{Error, Result},
    layout::{StructRef, Types, utf16le_lossy},
    memory::{self, AddressSpace, DTB_IDENTITY, PAGE_SIZE},
    pe::{PeImage, read_pe_header_page, read_pe_image, read_pe_version_info, size_of_image},
    phys::PhysMem,
    symbols::{
...
#[cfg(test)]
mod tests {
    use super::{ModuleSymbolLoadReport, find_ntoskrnl_va, partition_first_occurrence};
